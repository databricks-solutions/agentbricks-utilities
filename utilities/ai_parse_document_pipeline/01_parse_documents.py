...
dbutils.widgets.text(
    "source_volume_path", "/Volumes/main/default/source_docs", "Source volume path"
)
dbutils.widgets.text(
    "output_volume_path", "/Volumes/main/default/parsed_images", "Output volume path"
)
dbutils.widgets.text(
    "checkpoint_location",
    "/Volumes/main/default/_checkpoints/parse_documents",
    "Checkpoint location",
)
